    ...
    <div className="p-8">
      <div className="flex items-center justify-between mb-6">
        <div>
          ...
          <p className="text-gray-500 mt-1">Generate and manage avatar videos</p>
        </div>
      ...
      {showGenerator && (
        <div className="card p-6 mb-6">
          <h2 className="font-semibold text-gray-900 mb-4">New video</h2>
          <div className="grid md:grid-cols-2 gap-4">
            ...
            <div className="md:col-span-2">
              ...
              <div className="text-xs text-gray-400 mt-1">{form.script.length} characters · ~{Math.ceil(form.script.split(' ').length / 150)} min video</div>
            </div>
            <div>
            ...
            <div className="flex items-end gap-4">
              <label className="flex items-center gap-2 cursor-pointer select-none">
                ...
                <span className="text-sm text-gray-600">Test mode (no credits)</span>
              </label>
            </div>
          </div>
      ...
      {isLoading ? (
        ...
        <div className="text-center py-16">
          ...
          <p className="text-gray-500 text-sm mb-4">Generate your first avatar video</p>
          ...
          <table className="w-full">
            <thead className="bg-gray-50 border-b border-gray-100">
              <tr>
                ...
                <th className="text-left px-4 py-3 text-xs font-semibold text-gray-500 uppercase tracking-wide">Avatar</th>
            ...
            <tbody className="divide-y divide-gray-100">
              {videos.map((v: any) => (
                <tr key={v.id} className="hover:bg-gray-50 transition-colors">
                  <td className="px-4 py-3">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <div className="text-xs text-gray-400 truncate max-w-xs">{v.script?.substring(0, 60)}...</div>
                      </div>
                    </div>
                  </td>
                  <td className="px-4 py-3 text-sm text-gray-600">{v.avatar?.name || '—'}</td>
                  <td className="px-4 py-3">
                  ...
                  <td className="px-4 py-3 text-sm text-gray-600">{v.creditsCost || 0}</td>
                    ...
                    <div className="flex items-center gap-2">
                      {v.url && (
                        <>
                          <a href={v.url} target="_blank" rel="noopener noreferrer"
                            className="text-gray-400 hover:text-brand-600 transition-colors" title="Play">
                            <Play className="w-4 h-4" />
                          </a>
                          <a href={v.url} download className="text-gray-400 hover:text-brand-600 transition-colors" title="Download">
                      ...
                      {v.shareToken && (
                        <button
                          ...
                          className="text-gray-400 hover:text-brand-600 transition-colors" title="Copy share link">
